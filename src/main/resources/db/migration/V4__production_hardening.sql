...
VALUES
    ('s1111111-1111-1111-1111-111111111101', 'shared_cluster', 'jdbc:postgresql://localhost:5432/ut_einvoice_db', TRUE, 500000),
    ('s1111111-1111-1111-1111-111111111102', 'enterprise_shard_01', 'jdbc:postgresql://localhost:5432/ut_enterprise_01', TRUE, 10000)
